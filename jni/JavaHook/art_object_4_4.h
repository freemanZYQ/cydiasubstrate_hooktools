...
//  	DCHECK_LT(i, NumberOfVRegs());
    ...
    mirror::Object* GetThisObject() const SHARED_LOCKS_REQUIRED();

    mirror::Object* GetThisObject(uint16_t num_ins) const SHARED_LOCKS_REQUIRED();
...
public:
	...
	bool IsValidIndex(int32_t index) const SHARED_LOCKS_REQUIRED();
...
public:
	...
	Class* GetSuperClass() const SHARED_LOCKS_REQUIRED (){
	...
	DexCache* GetDexCache() const SHARED_LOCKS_REQUIRED (){
